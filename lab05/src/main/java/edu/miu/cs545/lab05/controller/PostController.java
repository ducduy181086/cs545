...
import edu.miu.cs545.lab05.helper.FilterParser;
import edu.miu.cs545.lab05.service.PostService;
...
public class PostController {
    ...
    public ResponseEntity<List<PostDto>> get(@RequestParam(required = false) String filter) {
        ...
        else if (filters.containsKey("title")) {
            posts = postService.getByTitle(filters.get("title"));
        }
        else {

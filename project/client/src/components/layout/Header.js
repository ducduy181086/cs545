            ...
            <div className="container mx-auto p-4">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        <h1 className="text-2xl font-bold text-gray-900">eGrocery Market</h1>
                        <div className="relative">
                            <input
                                type="text"
                                placeholder="Search for products"
                                className="w-96 p-3 pl-10 bg-white border rounded-full text-sm shadow-sm focus:outline-none focus:ring focus:ring-lime-100"
                            />

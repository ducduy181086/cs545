package edu.miu.cs545.lab04.aspect;

import edu.miu.cs545.lab04.entity.Logger;
import edu.miu.cs545.lab04.repository.ExceptionRepo;
import edu.miu.cs545.lab04.repository.LoggerRepo;
...
public class LoggerAspect {
    ...
    @Pointcut("execution(* edu.miu.cs545.lab04.controller..*(..)) || " +
            "execution(* edu.miu.cs545.lab04.service..*(..))")
    public void logMe() { }
    ...
    public void logMeAfterThrowing(JoinPoint joinPoint, Throwable ex) {
        ...
        exceptionRepo.save(new edu.miu.cs545.lab04.entity.Exception(0, dateTime, principle, operation, exception_type));
    }
}
